    ...
    return (
        <div className="min-h-screen flex flex-col mt-12 w-full px-4 sm:px-8 pb-6">
            ...
            <Link href="/classID/QnABoard/NewBoard">
                <div className="mb-5 pl-20 pr-20 bottom-0 left-2/4 bg-content-light rounded-3xl flex flex-row items-center justify-center p-4 fixed text-salate-1000 transform -translate-x-1/2">
