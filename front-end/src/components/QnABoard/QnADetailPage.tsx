...
const Comment = [
    ...
    },
    {
        ...
        profileImage: profile,
        comment: "Cristiano Ronaldo's success story is a perfect example of how hard work and determination can lead to greatness in any field, including academics.",
