...
const QnACard: React.FC<QnACardProps> = ({
    ...
    return (
        <div className={`bg-content-light shadow-2xl rounded-lg p-4 pl-12 pt-8 mb-8 mr-8 ${size_card} text-salate-1000 overflow-hidden `}>
            <div className='flex flex-row mb-4'>
                <h1 className='font-bold text-xl text-primary truncate pr-4 w-full'>{board_title}</h1>
